...
include('header.php');
?>
<div class="contact-container" style="background-color:rgba(209, 209,209); color:black;">
    ...
    <div class="contact1">
        ...
        <div class="book-p">
            <p> Customer Care Number, Contact Address, Email Id. Hotels.com is an </p>
        </div>
