...
<html>
	...
	<body>
		...
		<table cellpadding="5">
			<tr>
				<td class="admin_func"><a href="book_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i>Réserver des billets d'avion</a>
				</td>
			</tr>
		
			<tr>
				<td class="admin_func"><a href="cancel_booked_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i> Annuler les billets d'avion réservés
</a>
				</td>
			</tr>
		</table>
